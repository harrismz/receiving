...
<head>
	...
	<script type="text/javascript">
		...
		function loadform(){ $("#filterTable").focus(); }
...
<body onload="loadform()">
	<div data-role="page" id="pagedata">
		...
		<!--	<form><input id="filterTable-input" data-type="search" placeholder="search by"></form>	
			...
			<input id="filterTable" data-type="search" placeholder="search by" />
			<table id="app-status-table" data-role="table" class="ui-responsive">
				<thead>
                </thead>
                <tbody></tbody>
			</table>
