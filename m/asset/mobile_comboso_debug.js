...
$(document).ready(function(){
	...
	$("#hide_issueke").focusout(function(){
...
function scanpart_onclick2(){
	...
	/*call json SO*/
	$.post('scanjsonso_comboso.php', {dept_part: $('[name=hide_dept]').val(), issueke: $('[name=hide_issueke]').val(), date_part: $('[name=hide_date]').val(), line: $('[name=hide_line]').val(), model: $('[name=hide_model]').val(), prodno: $('[name=hide_prodno]').val(), lot: $('[name=hide_lot]').val(), qty: $('[name=hide_qty]').val()},
	function(result){
		var listItems = "";
...
function scanpartcode_onclick(){
	...
	/*call data part*/
	//$.post('scanpartcode_comboso.php', {partcode: $('[name=partcode]').val(), issueke: $('[name=hide_issueke]').val()},
	$.post('scanpartcode_comboso_debug.php', {partcode: $('[name=partcode]').val(), issueke: $('[name=hide_issueke]').val()},
	function(result){
		$('#scanpart').html(result).show();
	});
	/*end call data part*/
	...
	/*call json SO*/
	$.post('scanjsonsocode_comboso.php', {partcode: $('[name=partcode]').val(), issueke: $('[name=hide_issueke]').val()},
	function(result){
		var listItems = "";
		var jsonListSO = $.parseJSON(result);
		listItems="<option value=''>--SELECT SO NUMBER--</option>";
...
function partcode_model(){
	...
	/*call data part*/
	$.post('scanmodel_comboso.php', {partcode: $('[name=partcode]').val()},
	function(result){
...
function issueke_partcode(){
	...
	$.post('scanissuekecode_comboso_debug.php', {partcode: $('[name=partcode]').val(), issueke: $('[name=hide_issueke]').val()},
	function(result){
...
function startnik(){
	...
	/*call data part*/
	//$.post('scanpartcode_comboso.php', {partcode: $('[name=""]').val(), issueke: $('[name=""]').val()},
	$.post('scanpartcode_comboso_debug.php', {partcode: $('[name=""]').val(), issueke: $('[name=""]').val()},
	function(result){
		$('#scanpart').html(result).show();
	});
	/*end call data part*/
	...
	/*call json SO*/
	$.post('scanjsonsocode_comboso.php', {partcode: $('[name=""]').val(), issueke: $('[name=""]').val()},
	function(result){
		var listItems = "";
		var jsonListSO = $.parseJSON(result);
		listItems="<option value=''>--SELECT SO NUMBER--</option>";
	...
	/*call data part*/
	$.post('scanmodel_comboso.php', {partcode: $('[name=""]').val()},
	function(result){
		$('#show_partlist').html(result).show();
	});
	/*end check model*/
...
function checkmodel(){
	...
	/*DELETE VALUE TEXTBOX 
	document.getElementById('dept_part').innerHTML= "";
	document.getElementById('date_part').innerHTML= "";
	document.getElementById('line').innerHTML     = "";
	document.getElementById('model').innerHTML    = "";
	document.getElementById('prodno').innerHTML   = "";
