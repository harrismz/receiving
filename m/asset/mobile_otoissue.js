...
function scanissue_onclick(){
	if (nik.value==""){
		...
		$.post('scanissue_use_otoissue.php',{
			nik		: $('[name=nik]').val(),
			idso	: $('[name=idso]').val(),
...
function scanpart_onclick(){
	...
	$.post('scanpart_use_otoissue.php', {dept_part: $('[name=dept_part]').val(), date_part: $('[name=date_part]').val(), line: $('[name=line]').val(), model: $('[name=model]').val(), prodno: $('[name=prodno]').val(), lot: $('[name=lot]').val(), qty: $('[name=qty]').val()},
	function(result){
...
function scanpart_onclick2(){
	...
	$.post('scanpart_use_otoissue.php', {dept_part: $('[name=hide_dept]').val(), issueke: $('[name=hide_issueke]').val(), date_part: $('[name=hide_date]').val(), line: $('[name=hide_line]').val(), model: $('[name=hide_model]').val(), prodno: $('[name=hide_prodno]').val(), lot: $('[name=hide_lot]').val(), qty: $('[name=hide_qty]').val()},
	function(result){
		$('#scanpart').html(result).show();
	});
	return false;
...
/*function issueke(){
	...
	$.post('scanissueke_use_otoissue.php', {dept_part: $('[name=hide_dept]').val(), date_part: $('[name=hide_date]').val(), line: $('[name=hide_line]').val(), model: $('[name=hide_model]').val(), prodno: $('[name=hide_prodno]').val(), lot: $('[name=hide_lot]').val(), qty: $('[name=hide_qty]').val()},
	function(result){
...
function startnik(){
	...
	$.post('scanissue_use_otoissue.php', {nik: $('[name=""]').val(), idso: $('[name=""]').val(), parthdn1: $('[name=""]').val(), parthdn2: $('[name=""]').val(), partpo2: $('[name=""]').val(), partqty2: $('[name=""]').val()},
	function(result){
		$('#scanissue').html(result).show();
	});
	$('#scanpart').html(
	...
	$.post('scanpart_use_otoissue.php', {dept_part: $('[name=""]').val(), date_part: $('[name=""]').val(), line: $('[name=""]').val(), model: $('[name=""]').val(), prodno: $('[name=""]').val(), lot: $('[name=""]').val(), qty: $('[name=""]').val()},
	function(result){
		$('#scanpart').html(result).show();
	});
	return false;
