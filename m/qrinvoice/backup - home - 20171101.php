	...
	<div data-role="page" id="pagehome">
		...
		<div data-role="navbar">
			<ul>
				...
				<li><a href="#" class="ui-btn ui-icon-bullets ui-btn-icon-left" onclick="todatarecap()" title="View Data Recap">Summary Data Receive</a></li>
			</ul>
		</div>
		...
		<div data-role="main" class="ui-content">				
			<div class="ui-field-contain">
				...
				<label for="barcode" style="font-weight:bold;color:grey;">Barcode</label>
					<input type="text" name="barcode" id="barcode" data-clear-btn="true" placeholder="Barcode" onkeypress="keybar(event)">
			</div>
			<!--
