    ...
    $(document).ready(function() {
     ...
     /*
		function audioplay() {
			...
			//audiocontrol.play();
			audiocontrol.play();
			audiocontrol.removeAttr("controls");
		} */
    });
...
if ($_SERVER['REQUEST_METHOD'] != 'POST')
...
else  // jika hasil dari postingan .......
 {
  ...
  echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PO : ' . $varpo . '&nbsp;&nbsp;***';
  echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;QTY : ' . $varqty . '<br />';
  echo "select sa90m.so,sa90m.partno,sa90m.partname,sa90m.qty,visspart.scanqty,sa90m.bom,sa90m.lot,sa90m.line,sa90m.model from sa90m left join visspart on sa90m.so = visspart.issso and sa90m.partno = visspart.isspartno where sa90m.so = '$txtso' order by visspart.issdate desc";
...
?><script>
  ...
  if(!$row_check)
	...
	// $suara = 'BELUM_TERDAFTAR.mp3';
	  // echo "<embed src =\"$suara\" hidden=\"true\" autostart=\"true\"></embed>";
	
	   echo "<audio controls autoplay hidden=\"hidden\"><source src =\"BELUM_TERDAFTAR.mp3\" type=\"audio/mp3\"></audio>";
	 return false;
	}
  ...
  if($txtbarcode != "")
   {
     ...
     $sqlview = "select sa90m.so,sa90m.partno,sa90m.partname,sa90m.qty,visspart.scanqty,ROUND(CAST (sa90m.bom AS decimal (6,2)),-3) AS bom,sa90m.lot,sa90m.line,sa90m.model from sa90m left join visspart on  sa90m.so = visspart.issso and sa90m.partno = visspart.isspartno  where sa90m.so = '$txtso'";
    ...
    <?php
		/*insert dimatikan jika sudah fix hidupkan lagi !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
