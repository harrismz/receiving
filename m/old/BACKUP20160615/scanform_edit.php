    ...
    <div id="form" class="col-sm-8 col-sm-offset-2">
        <form method="post" action="scanissue_edit.php" target="scanissue" onsubmit="mulai()">
            <div class="form-group">
				<label class="control-label col-sm-12"  for="astno">SO NUMBER (---EDIT---)</label>
				<div class="col-sm-12">
					<input class="form-control" type="text" name="so" id="idso" class="kelas1" />
				</div>
			</div>
            <div class="form-group">
				<label class="control-label col-sm-12"  for="astno">ISSUE SEQ (---EDIT---)</label>
				<div class="col-sm-12">
					<input class="form-control" type="text" name="issueseq" id="issueseq" class="kelas1" />
				</div>
			</div>
            <div class="form-group">
				<label class="control-label col-sm-12"  for="astno">BARCODE SCAN (---EDIT---)</label>
				<div class="col-sm-12">
