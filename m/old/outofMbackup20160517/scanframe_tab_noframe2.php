...
<iframe src="scanform_tab_noframe2.php" name="scanform" style="height:30%;width:100%;"></iframe>
<iframe src="scanissue_tab_noframe2.php" name="scanissue" style="height:70%;width:100%;"></iframe>
<body>
</body>
</body>
<noframes>
