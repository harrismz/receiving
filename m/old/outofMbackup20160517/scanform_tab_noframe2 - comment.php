			...
			<div id="tabs">
				...
				<!-- START FORM -->
					<form method="post" action="scanissue_tab.php" target="scanissue" onsubmit="return mulai();">
						...
						<div id="tabs-1">
							<table>
								<tr><td width="120px">NIK</td>			<td>:</td>	<td><input type="text"	name="nik1"	id="nik1"	class="kelas1"/></td></tr>
								<tr><td width="120px">SO NUMBER</td>	<td>:</td>	<td><input type="text"	name="idso1"	id="idso1"	class="kelas1"/></td></tr>
						...
						<div id="tabs-2">
							<table>
								<tr><td width="120px">NIK</td>			<td>:</td>	<td><input type="text"	name="nik2"	id="nik2"	class="kelas1"/></td></tr>
								<tr><td width="120px">SO NUMBER</td>	<td>:</td>	<td><input type="text"	name="idso2"	id="idso2"	class="kelas1"/></td></tr>
								<tr><td width="120px">PART NO</td>	<td>:</td>	<td><input type="text"	name="idbarcode2"	id="idbarcode2"	class="kelas1" autofocus/></td></tr>
								<tr><td width="120px">PO</td>		<td>:</td>	<td><input type="text"	name="po2"			id="po2"		class="kelas1" maxlength="7" onKeypress="return isNumberKey(event)"/></td></tr>
