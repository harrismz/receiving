...
$txtnikPost1 = isset($_POST['nik1']) ? $_POST['nik1'] : "";
$txtnikPost2 = isset($_POST['nik2']) ? $_POST['nik2'] : "";
$txtsoPost1  = isset($_POST['idso1']) ? $_POST['idso1'] : "";
$txtsoPost2  = isset($_POST['idso2']) ? $_POST['idso2'] : "";
...
if($varpartPost1 != "" and $varpartPost2 == ""){
	...
	$txtnik	    = strtoupper(trim($txtnikPost2));
	$txtso	    = strtoupper(trim($txtsoPost2));
