...
<body onload="loadform()">
	<div data-role="page" id="pagehome">
		...
		<div data-role="navbar">
			<ul>
				<li><a href="data.php" data-icon="search"></a></li>
			</ul>
		</div>
		...
		<div data-role="main" class="ui-content">				
			<div class="ui-field-contain">
				<label for="nik" style="font-weight:bold;color:grey;">NIK</label>
					<input type="text" name="nik" id="nik" data-clear-btn="true" placeholder="NIK">
				...
				<label for="barcode" style="font-weight:bold;color:grey;">Barcode</label>
					<input type="text" name="barcode" id="barcode" data-clear-btn="true" placeholder="Barcode">
			</div>
