...
function issueke_partcode(){
	...
	$.post('scanissuekecode_comboso.php', {partcode: $('[name=partcode]').val(), issueke: $('[name=hide_issueke]').val()},
	function(result){
...
function tombol_submit(){
	...
	//issueseq_label.innerHTML = hide_issueke.value; *karna tidak ada max issue 
...
function startnik(){
	...
	$.post('scanpart_comboso.php', {dept_part: $('[name=""]').val(), issueke: $('[name=""]').val(), date_part: $('[name=""]').val(), line: $('[name=""]').val(), model: $('[name=""]').val(), prodno: $('[name=""]').val(), lot: $('[name=""]').val(), qty: $('[name=""]').val()},
	function(result){
		$('#scanpart').html(result).show();
	});
	/*end call data part*/
	...
	/*call json SO*/
	$.post('scanjsonso_comboso.php', {dept_part: $('[name=""]').val(), issueke: $('[name=""]').val(), date_part: $('[name=""]').val(), line: $('[name=""]').val(), model: $('[name=""]').val(), prodno: $('[name=""]').val(), lot: $('[name=""]').val(), qty: $('[name=""]').val()},
	function(result){
		var listItems = "";
		var jsonListSO = $.parseJSON(result);
		listItems="<option value=''>--SELECT SO NUMBER--</option>";
...
/*20160616
function selectso(){
	if (hide_dept.value=="" || hide_date.value=="" || hide_line.value=="" || hide_model.value=="" || hide_prodno.value=="" || hide_lot.value=="" || hide_qty.value==""){
		//dept_part.focus();
		alert('Tampilkan Partlist dulu dengan klik tombol (NEW LIST)');
		idso.value = "";
		so_label.innerHTML = "";
