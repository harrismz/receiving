...
<body>
	...
	<!--	<button class="btn btn-info col-sm-6 css_button2" type="button" name="btn_newpart" id="btn_newpart" onClick="newPart()"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;&nbsp;NEW LIST</button>
		...
		<button class="btn btn-info col-sm-12 css_button" type="button" name="btn_refrespartcode" id="btn_refreshpartcode" onClick="refreshPartcode()"><span class="glyphicon glyphicon-refresh"></span>&nbsp;&nbsp;&nbsp;REFRESH PARTLIST CODE</button>
	</div>
