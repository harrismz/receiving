						...
						if ($issueke != ""){
							...
							if ($chkpartlist != 0 && ($tot_qtyscan > $scan_issue) ){
								...
								*/
								...
								$checkunix2 = 0;
								$checkunix2 = strlen($varunique);
								if ($checkunix2 == 46 or $varunique == "" or $checkunix2 == 0)
								{	
									if($duplikat == 0)
									{
										$sqlins = "insert into partiss(so,partno,partname,po,bom,reqqty,scanqty,lot,line,model,issdate, nik, uniqueid) values('$txtso','$varpart','$nilainama','$varpo','$nilaibom','$nilaireq','$varqty','$nilailot','$nilailine','$nilaimodel','$tglins','$txtnik','$varunique')";
							...
							if ($chkpartlist != 0 && ($tot_qtyscan > $scan_issue) ){
								...
								*/
								...
								$checkunix3 = 0;
								$checkunix3 = strlen($varunique);
								if ($checkunix3 == 46 or $varunique == "" or $checkunix3 == 0)
								{
									if($duplikat == 0)
									{
										$sqlins = "insert into partiss(so,partno,partname,po,bom,reqqty,scanqty,lot,line,model,issdate, nik, uniqueid) values('$txtso','$varpart','$nilainama','$varpo','$nilaibom','$nilaireq','$varqty','$nilailot','$nilailine','$nilaimodel','$tglins','$txtnik','$varunique')";
								...
								$checkunix4 = 0;
								$checkunix4 = strlen($varunique);
								if ($checkunix4 == 46 or $varunique == "" or $checkunix4 == 0)
								{
									if($duplikat == 0)
									{
										$sqlins = "insert into partiss(so,partno,partname,po,bom,reqqty,scanqty,lot,line,model,issdate, nik, uniqueid) values('$txtso','$varpart','$nilainama','$varpo','$nilaibom','$nilaireq','$varqty','$nilailot','$nilailine','$nilaimodel','$tglins','$txtnik','$varunique')";
