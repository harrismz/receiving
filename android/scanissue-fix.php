  ...
  if(!$row_check)
	...
	// $suara = 'BELUM_TERDAFTAR.mp3';
	  // echo "<embed src =\"$suara\" hidden=\"true\" autostart=\"true\"></embed>";
	   ...
	   echo "<audio autoplay><source src =\"BELUM_TERDAFTAR.mp3\" type=\"audio/mp3\"></audio>";
	 return false;
	}
  ...
  if($txtbarcode != "")
   {
	 ...
	 echo 'status : ';
 	 if ($wrongpart == 1) 
      {
       if ($cekpart == 0)
		...
		// $suara = 'Over2good.wav';
		 echo "<audio autoplay><source src =\"LEBIH.mp3\" type=\"audio/mp3\"></audio>";
		// echo "<embed src =\"$suara\" hidden=\"true\" autostart=\"true\"></embed>";
        }
       if ($cekpart == 1)
        {
		/* $suara = 'SCAN_BERHASIL.mp3';
		 ...
		 <!-- <script>
		  ...
		  <?php
		   echo "<audio autoplay><source src =\"BERHASIL.mp3\" type=\"audio/mp3\"></audio>";
		?>
    ...
    <?php
	 ...
	 <!-- <script>
      ...
      <?php
	   echo "<audio autoplay><source src =\"SALAH.mp3\" type=\"audio/mp3\"></audio>";
	  }
