...
<script>
	...
	function view_partcode(){
		...
		$.post('print_partcode_sch_view.php', {issdate: $('[name=issue_date]').val(), issdept: $('[name=issue_dept]').val()},
		function(result){
	...
	function reset_partcode(){
		...
		$.post('print_partcode_sch_view.php', {issdate: $('[name=""]').val(), issdept: $('[name=""]').val()},
		function(result){
			$('#view_partlist').html(result).show();
		});
		return false;
