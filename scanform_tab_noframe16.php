...
function scanissue_onclick(){
	...
	$.post('scanissue_tab_noframe16.php', {nik: $('[name=nik]').val(), idso: $('[name=idso]').val(), parthdn1: $('[name=parthdn1]').val(), parthdn2: $('[name=parthdn2]').val(), partpo2: $('[name=partpo2]').val(), partqty2: $('[name=partqty2]').val()},
		function(result){
...
<!--	<form method="post" id="form1" onsubmit="scanissue2()"> -->
	<form method="post" id="form1">
		<table>
			...
			<td/><tr><td colspan="3" style="background-color:gray;"></td></tr><td/>
			<tr><td width="160px">PART NO</td>		<td>:</td>	<td><input type="text"	name="idbarcode2"	id="idbarcode2"	class="kelas1" onkeypress="etr(event)" maxlength="15"/></td></tr>
			<tr><td width="160px">PO</td>			<td>:</td>	<td><input type="text"	name="po2"			id="po2"		class="kelas1" onkeypress="etr(event)" maxlength="7"/></td></tr>
			<tr><td width="160px">QTY</td>			<td>:</td>	<td><input type="text"	name="qty2"			id="qty2"		class="kelas1" onkeypress="etr(event)" maxlength="5"/></td></tr>
			<td/><tr><td colspan="3" style="background-color:gray;"></td></tr><td/>
