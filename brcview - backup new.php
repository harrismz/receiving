...
if ($_SERVER['REQUEST_METHOD'] != 'POST')
...
else
  {
	...
	echo '<a href="brcpreview.php?partno='. $partno .'&po='. $po .'&suppname='. $suppname .'&pack='. $pack .'&qtystd='. $qtystd .'&qtybal='. $qtybal .'&qty='. $qty .'&qty='. $qty .'&lokasi='. $lokasi .'&supp='. $supp .'&invno='. $invno .'">Print SATO Label New</a></td>'; 
	

	
	$host		= getenv("REMOTE_ADDR");
	if(  $host == '10.230.30.104' || $host == '136.198.117.40' || $host == '10.230.30.102' ){
		echo '<br>';
		echo '<a href="brcpreview.php?partno='. $partno .'&po='. $po .'&suppname='. $suppname .'&pack='. $pack .'&qtystd='. $qtystd .'&qtybal='. $qtybal .'&qty='. $qty .'&qty='. $qty .'&lokasi='. $lokasi .'&supp='. $supp .'&invno='. $invno .'">Print SATO</a></td>'; 
	}
/*
