		...
		echo '<table border="0" cellpadding="5" cellspacing="0" width="100%" style="font-weight:bold; font-size=18pt">';
			...
			echo '<tr>';
				echo '<td style="color:#0000ff" colspan="2">';
					echo '<a href="brcprint_unix.php?partno='. $partno .'&po='. $po .'&suppname='. $suppname .'&pack='. $pack .'&qtystd='. $qtystd .'&qtybal='. $qtybal .'&qty='. $qty .'&lokasi='. $lokasi .'&supp='. $supp .'&invno='. $invno .'">Print SATO Label</a>';
				echo '</td>';
			echo '</tr>';
		echo '</table>';
	}
