...
<?php
	...
	if(isset($_GET['partno']))
	{
		...
		if( $qtystd != 0){
			...
			$data .= $esc . 'H0180' . $esc . 'V0015' . $esc . 'L0101' . $esc . 'M' . 'Loc: ' . $lokasi;
			$data .= $esc . 'H0180' . $esc . 'V0059' . $esc . 'L0101' . $esc . 'M' . 'Supp: ' . $supp;
			$data .= $esc . 'H0180' . $esc . 'V0100' . $esc . 'L0101' . $esc . 'M' . 'PO: ' . $po;
			$data .= $esc . 'H0370' . $esc . 'V0015' . $esc . 'L0101' . $esc . 'M' . 'Invc: ' . $invno;
			$data .= $esc . 'H0370' . $esc . 'V0100' . $esc . 'L0101' . $esc . 'M' . 'QTY: ' . $pack;
			$data .= $esc . 'H0518' . $esc . 'V0100' . $esc . 'L0101' . $esc . 'M' . $partno;
			$data .= $esc . 'Q'. $qtystd .'';
			$data .= $esc . 'Z';
			$handle2 = $data;
		}
		...
		if( $qtybal != 0){
			...
			$data .= $esc . 'H0180' . $esc . 'V0100' . $esc . 'L0101' . $esc . 'M' . 'PO: ' . $po;
			$data .= $esc . 'H0370' . $esc . 'V0015' . $esc . 'L0101' . $esc . 'M' . 'Invc: ' . $invno;
			$data .= $esc . 'H0370' . $esc . 'V0100' . $esc . 'L0101' . $esc . 'M' . 'QTY: ' . $qtybal;
			$data .= $esc . 'H0518' . $esc . 'V0100' . $esc . 'L0101' . $esc . 'M' . $partno;
			$data .= $esc . 'Q1';
			$data .= $esc . 'Z';
			$handle3 = $data;
		...
		$data .= $esc . 'H0370' . $esc . 'V0015' . $esc . 'L0101' . $esc . 'M' . 'Inv: ' . $invno;
		$data .= $esc . 'H0370' . $esc . 'V0100' . $esc . 'L0101' . $esc . 'M' . 'QTY: ' . $qtybal;
