...
echo '<a href="index.php">menu</a><br />Data hasil upload : <br />';
  ...
  { 		
	...
	// hapus data di sa90
        ...
        $sqlins = "insert into sa90_so select convert(char,c),convert(char,i),j,convert(float,p),convert(float,q),ad,an,ac,convert(char,ab) from sa90temp_so";	       
	...
	if($cek == 0)          
	  {
		...
		echo $part;
		echo ' is nothing.. inserting ...<br />';
				$ins_sa90prod = "insert into sa90prod_so select * from sa90prodtemp_so where so = '$so' and partno = '$part'";					
